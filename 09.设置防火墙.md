...
黑洞路由 `blackhole route` 是一组静态路由，基于 [RFC6890 - Special-Purpose IP Address Registries](https://www.rfc-editor.org/rfc/rfc6890) 创建。  
...
||不勾选|`10.0.0.0/8`|`Null4`|`RFC6890 - private use`||
||不勾选|`100.64.0.0/10`|`Null4`|`RFC6890 - shared address space`||
||勾选|`127.0.0.0/8`|`Null4`|`RFC6890 - loopback`|按需启用|
||不勾选|`169.254.0.0/16`|`Null4`|`RFC6890 - link local`||
||不勾选|`172.16.0.0/12`|`Null4`|`RFC6890 - private use`||
||不勾选|`192.0.0.0/24`|`Null4`|`RFC6890 - IETF protocol`||
||不勾选|`192.0.0.0/29`|`Null4`|`RFC6890 - DS-Lite`||
||不勾选|`192.0.2.0/24`|`Null4`|`RFC6890 - TEST-NET-1`||
||不勾选|`192.88.99.0/24`|`Null4`|`RFC6890 - 6to4 relay anycast`||
||不勾选|`192.168.0.0/16`|`Null4`|`RFC6890 - private use`||
...
||不勾选|`255.255.255.255/32`|`Null4`|`RFC6890 - limited broadcast`||
...
|路由类型|禁用|网络地址|网关|描述|说明|
|--|--|--|--|--|--|
|IPv6|勾选|`::1/128`|`Null6`|`RFC6890 - loopback`|按需启用|
||勾选|`::/128`|`Null6`|`RFC6890 - unspecified`|按需启用|
||不勾选|`64:ff9b::/96`|`Null6`|`RFC6890 - IPv4-IPv6 translate`||
||不勾选|`::ffff:0:0/96`|`Null6`|`RFC6890 - IPv4-mapped`||
||不勾选|`100::/64`|`Null6`|`RFC6890 - discard-only`||
||不勾选|`2001::/23`|`Null6`|`RFC6890 - IETF protocol`||
...
||不勾选|`fc00::/7`|`Null6`|`RFC6890 - unique-local`||
||不勾选|`fe80::/10`|`Null6`|`RFC6890 - linked-scoped unicast`||
